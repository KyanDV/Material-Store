...
class _OwnerHomeScreenState extends State<OwnerHomeScreen> {
  ...
  // Fungsi untuk menghapus toko dari Firestore
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            // Kembali ke halaman sebelumnya (RoleSelectionScreen)
            Navigator.of(context).pop();
          },
        ),
        actions: [
      ...
      body: StreamBuilder<QuerySnapshot>(
        // Mengambil data toko yang 'ownerId'-nya sama dengan ID pengguna yang login
                    ...
                    ListTile(
                      ...
                      onTap: () {
                        ...
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) => EditStoreScreen(storeId: storeDoc.id),
                          ),
                        );
                      },
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton.icon(
                          ...
                          onPressed: () {
                            _showDeleteConfirmationDialog(storeDoc.id, storeName);
                          },
                        ),
                      ],
                    )
